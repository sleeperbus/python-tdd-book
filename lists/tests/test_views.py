...
class ListViewTest(TestCase):
    ...
    def test_duplicate_item_validation_errors_up_on_list_page(self):
...
class NewListViewUnitTest(unittest.TestCase):
    ...
    def test_redirects_to_form_returned_objects_if_form_is_valid(self, mock_redirect, mockNewListForm):
        mock_form = mockNewListForm.return_value
        mock_form.is_valid.return_value = True
